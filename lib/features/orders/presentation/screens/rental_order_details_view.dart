...
import '../widgets/details/rental_contract_card.dart';
import '../widgets/details/rental_assigned_worker_card.dart';

class RentalOrderDetailsView extends ConsumerWidget {
  final String orderId;

  const RentalOrderDetailsView({super.key, required this.orderId});
              ...
              data: (orderDetails) {
                return ListView(
                  ...
                  children: [
                    ...
                    RentalAssignedWorkerCard(order: orderDetails),
                    SizedBox(height: 20.h),
                    RentalContractCard(order: orderDetails),
                    SizedBox(height: 20.h),
